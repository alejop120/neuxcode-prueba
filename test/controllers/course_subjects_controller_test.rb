...
class CourseSubjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create course_subject" do
    assert_difference('CourseSubject.count') do
      post course_subjects_url, params: { course_subject: { course: @course_subject.course, subject: @course_subject.subject } }
    end
  ...
  test "should update course_subject" do
    patch course_subject_url(@course_subject), params: { course_subject: { course: @course_subject.course, subject: @course_subject.subject } }
